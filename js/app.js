...
angular.module('moviesowlApp', [
    ...
    .run(function ($ionicPlatform,
        ...
        $ionicPlatform.ready(function () {
            // load the favourites from local storage
            if(localStorage.favouriteCinemas) {
                $rootScope.favouriteCinemas = angular.fromJson(localStorage.favouriteCinemas);
            } else {
                $rootScope.favouriteCinemas = [{}];
            }
            $rootScope.favouriteCinema = $rootScope.favouriteCinemas[0];
            ...
            .state('movies', {
                ...
                views: {
                    'tab-movies': {
                        ...
                        controller: 'FavouritesShowController as vm'
                    }
                }
            })
            .state('cities', {
