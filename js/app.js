    ...
    .run(function ($ionicPlatform, ENV, $rootScope, autoupdate) {
        ...
        $ionicPlatform.ready(function () {
            if (window.cordova) {
                ...
                cordova.InAppBrowser.open('https://www.eventcinemas.com.au/Ticketing/Order#token=a0c58bba32e6e2ef86ec99b2a2d9f698&step=tickets', '_blank', 'location=no,toolbar=yes,clearcache=yes');
            }
